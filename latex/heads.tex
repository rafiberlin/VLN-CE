\begin{table}
\centering
\caption{\label{tab:heads}Subset of experiments' results, grouped by agent and ranked by descending SPL on the Validation Unseen data split. The rank in column \# is also used as a look up id in table \ref{tab:all-configs-final} to link the corresponding training configuration.     \newline The agents are based on Decision Transformer ('DT'), Enhanced Decision Transformer ('E-DT') or Full Decision Transformer ('F-DT').}
...
\midrule
         ...
         77 &           E-DT &                     train &              8.36 &        8.91 &          0.44 &        0.31 &        0.21 &         0.20 &                8.06 &        9.64 &          0.40 &        0.23 &        0.15 &         0.14 \\
         ...
         99 &           F-DT &                     train &              8.40 &        8.07 &          0.48 &        0.35 &        0.25 &         0.23 &                7.80 &        9.39 &          0.40 &        0.22 &        0.15 &         0.14 \\
\bottomrule
\end{tabular}
\end{table}
