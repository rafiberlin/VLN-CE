...
\caption{\label{table:f_dt_test_final} Best F-DT agent compared with best R2R-CE baseline and best DT and E-DT agents on test split. \textbf{Bold} numbers indicate the best results (except for TL)}
